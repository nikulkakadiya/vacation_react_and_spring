                        ...
                        <table class="timetable_sub">
                           ...
                           <tbody>
                              <tr class="rem1">
                                 ...
                                 <td class="invert-image"><a href="single.jsp"><img src="images/f1.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                              ...
                              <tr class="rem2">
                                 ...
                                 <td class="invert-image"><a href="single.jsp"><img src="images/f2.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                                       <div class="quantity-select">
                                          <div class="entry value-minus">&nbsp;</div>
                              ...
                              <tr class="rem3">
                                 ...
                                 <td class="invert-image"><a href="single.jsp"><img src="images/f3.jpg" alt=" " class="img-responsive"></a></td>
                                 <td class="invert">
                                    <div class="quantity">
                                       <div class="quantity-select">
                                          <div class="entry value-minus">&nbsp;</div>
